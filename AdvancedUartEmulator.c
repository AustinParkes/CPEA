...
#define MAIN_START   0x00010000  
#define MAIN_END     0x00010108  

// Set SP and FP manually for now to some unused memory location
#define FP_INIT      0x00020000
#define SP_INIT      0x00020000
...
int main(int argc, char **argv, char **envp)
{
	...
	int code_size;	
	FILE *f = fopen("AdvancedPollingUart.bin", "r");
